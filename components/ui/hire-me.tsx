    ...
    <Section className="texture" data-pattern="dot" id="contact">
      <div className="flex flex-col gap-8 text-center h-full">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 gap-4 w-full ">
          ...
          <div className="bg-(--surface-base) hover:bg-(--secondary-base) transition-all w-full min-h-[100px] md:col-span-3 grid content-center items-center text-headline text-(--text-inverse)  hover:text-(--text-base)">
            download a resume
          </div>
        </div>
      </div>
